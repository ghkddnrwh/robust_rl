...
def main():
    ...
    for r in R:
        ...
        # total_save_path = os.path.join("data_sac", "pendul", "pess_q_trial4", env_name, simulation_name)
        ...
        for perturb in perturb_list:
            ...
            perturb_reward.append(reward)
        total_reward.append(perturb_reward)

    print(total_reward)
    np.save(os.path.join(save_path, "perturb_test"), np.array(total_reward))
